        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">9</span>LAPTOP</h1>
                </a>
                <p>Mọi thắc mắc xin vui lòng liên hệ:</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>240/6 , Thái Thị Bôi, Đà Nẵng</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>thanhtinhtrinhtk123@gmail.com</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+84-3555-209-76</p>
            </div>
